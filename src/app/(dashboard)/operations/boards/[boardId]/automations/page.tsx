...
import { AutomationListPanel } from "@/components/operations/automations/automation-list-panel";
import { ArrowLeft } from "lucide-react";
import { useTranslations } from "next-intl";
import type { OperationBoard } from "@/types";

export default function OperationBoardAutomationsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      {accountId && <AutomationListPanel boardId={board.id} accountId={accountId} />}
    </div>
  );
}
