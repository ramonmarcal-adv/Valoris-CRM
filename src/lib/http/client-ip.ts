 ...
 *
 * Extracted from src/app/api/invitations/[token]/{peek,redeem}/route.ts
 * (previously duplicated verbatim in both) when Release D's public form
 * routes became a third consumer.
 */
